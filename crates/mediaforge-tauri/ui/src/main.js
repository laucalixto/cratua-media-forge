...
// ── Command Preview ──
async function updateCmdPreview(){try{const p=S.mode==='simple'?collectSimpleParams():collectAdvParams();const cmd=await invoke('build_command_preview',{params:p});if($('#cmd-preview'))$('#cmd-preview').value=cmd}catch(e){}}
